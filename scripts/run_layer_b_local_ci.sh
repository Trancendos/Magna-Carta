...
run_step "Trigger alignment" python3 scripts/trigger_alignment_check.py
run_step "Sector profiles" python3 scripts/sector_profiles_check.py
run_step "Capital governance" python3 scripts/capital_governance_check.py
