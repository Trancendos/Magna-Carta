# Legal & Contract Management Bible
...
Canonical reference for **legal & contract management** at Trancendos. Contract intake, review tiers, signature authority, litigation hold, regulatory correspondence.
...
| Type | ID | Status |
|------|-----|--------|
| Procedure | [PROC-LEG-001](../procedures/PROC-LEG-001-Legal-Contract-Management.md) | ✅ Programme |
| Cookbook | [COOK-LEG-001](../cookbooks/COOK-LEG-001-Legal-Contract-Management.md) | ✅ Programme |
| Hymn sheet | [HYMN-LEG-001](../hymn-sheets/HYMN-LEG-001-Legal-Contract-Management-Checklist.md) | ✅ Programme |
| Policies | Templates in docs/templates/ | See policies index |
...
```
Trigger → PROC-LEG-001 → COOK-LEG-001 → HYMN-LEG-001 → Evidence → PROC-CMP-001
```
