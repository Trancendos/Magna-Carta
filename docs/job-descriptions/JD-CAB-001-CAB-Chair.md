# JD-CAB-001 — Change Advisory Board (CAB) Chair

**Version:** 1.0.0  
**Date:** 2026-06-09  
**Status:** Template — requires executive appointment and compensation band  
**Reports to:** COO / Engineering Lead  
**Authority reference:** POL-OPS-002
...
- [PROC-CHG-001](../procedures/PROC-CHG-001-Change-Request.md)
- [PROC-CHG-002](../procedures/PROC-CHG-002-Post-Implementation-Review.md)
