# COOK-UMG-001 — Platform User Administration Playbook

**Version:** 1.0.0  
**Owner:** See [PROC-UMG-001](../procedures/PROC-UMG-001-Platform-User-Administration.md)  
**Procedure:** PROC-UMG-001  
**Hymn sheet:** [HYMN-UMG-001](../hymn-sheets/HYMN-UMG-001-Platform-User-Administration-Checklist.md)

---

## When to use

Scheduled review, audit preparation, or operational event requiring platform user administration workflow.
