# COOK-LEG-001 — Legal & Contract Management Playbook

**Version:** 1.0.0  
**Owner:** See [PROC-LEG-001](../procedures/PROC-LEG-001-Legal-Contract-Management.md)  
**Procedure:** PROC-LEG-001  
**Hymn sheet:** [HYMN-LEG-001](../hymn-sheets/HYMN-LEG-001-Legal-Contract-Management-Checklist.md)

---

## When to use

Scheduled review, audit preparation, or operational event requiring legal & contract management workflow.
