...
**Purpose:** Curated list of standards actively adopted or targeted by Magna Carta (STD-IDs). For the full customer-requested catalogue (127 frameworks, FW-001–FW-145), see [STANDARDS-AND-FRAMEWORKS-REGISTER.md](STANDARDS-AND-FRAMEWORKS-REGISTER.md), `compliance/frameworks_register.yaml`, and `compliance/framework_implementation_catalog.yaml`. Baseline execution evidence: `compliance/execution_evidence_register.yaml`.
...
| Date | Change | Author |
|------|--------|--------|
| 2026-06-09 | FW catalogue expanded to 127 (FW-133–145); implementation catalog + MON-018 | ISMS Lead |
