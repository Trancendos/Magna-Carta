# PROC-WLB-001 — Employee Wellbeing

**Version:** 1.0.0 · **Owner:** HR / People Lead · **Policies:** —
...
3. **Execute** — [COOK-WLB-001](../cookbooks/COOK-WLB-001-Employee-Wellbeing.md)
4. **Checklist** — [HYMN-WLB-001](../hymn-sheets/HYMN-WLB-001-Employee-Wellbeing-Checklist.md)
...
- [WELLBEING-BIBLE](../bibles/WELLBEING-BIBLE.md)
