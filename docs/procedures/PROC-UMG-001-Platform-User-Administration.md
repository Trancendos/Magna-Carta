# PROC-UMG-001 — Platform User Administration

**Version:** 1.0.0 · **Owner:** Platform Engineering / ISMS · **Policies:** POL-SEC-001, PROC-IAM-001
...
3. **Execute** — [COOK-UMG-001](../cookbooks/COOK-UMG-001-Platform-User-Administration.md)
4. **Checklist** — [HYMN-UMG-001](../hymn-sheets/HYMN-UMG-001-Platform-User-Administration-Checklist.md)
...
- [USER-MANAGEMENT-BIBLE](../bibles/USER-MANAGEMENT-BIBLE.md)
