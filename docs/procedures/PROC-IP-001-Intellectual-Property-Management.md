# PROC-IP-001 — Intellectual Property Management

**Version:** 1.0.0 · **Owner:** Legal / Engineering Lead · **Policies:** —
...
3. **Execute** — [COOK-IP-001](../cookbooks/COOK-IP-001-Intellectual-Property-Management.md)
4. **Checklist** — [HYMN-IP-001](../hymn-sheets/HYMN-IP-001-Intellectual-Property-Management-Checklist.md)
