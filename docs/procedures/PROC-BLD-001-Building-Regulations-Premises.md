# PROC-BLD-001 — Building Regulations & Premises

**Version:** 1.0.0 · **Owner:** Facilities / ISMS · **Policies:** —
...
3. **Execute** — [COOK-BLD-001](../cookbooks/COOK-BLD-001-Building-Regulations-Premises.md)
4. **Checklist** — [HYMN-BLD-001](../hymn-sheets/HYMN-BLD-001-Building-Regulations-Premises-Checklist.md)
...
- [BUILDING-BIBLE](../bibles/BUILDING-BIBLE.md)
