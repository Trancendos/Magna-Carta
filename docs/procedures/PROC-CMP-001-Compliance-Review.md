...
8. Legislation register scan ([LEGISLATION-REGISTER.md](../compliance/LEGISLATION-REGISTER.md), `compliance/legislation_register.yaml`); **EU EUR-Lex quarterly scan** ([EU-LEGISLATION-MONITORING.md](../compliance/EU-LEGISLATION-MONITORING.md), ACT-014); regulators/ombudsmen ([REGULATORS-OMBUDSMEN-REGISTER.md](../compliance/REGULATORS-OMBUDSMEN-REGISTER.md))
